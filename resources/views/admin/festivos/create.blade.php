...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form id="nuevo" action="{{ route('admin.festivos.store') }}" method="post" enctype="multipart/form-data" autocomplete="off">
                        @csrf

                        @isset($parametros['data']->festividad)
                        {{ method_field('patch') }}
                        @endif
                        <h4 class="header-title">CREAR NUEVA FESTIVIDAD</h4>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="festividad" id="festividad" class="form-control" placeholder="Evento no laborable" required="true" data-tipo="txt"/>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="fecha_descanso" id="fecha_descanso" class="form-control" required="true" data-tipo="txt"  data-traducir="false" data-toggle="input-mask" data-mask-format="00/00/0000" />
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="fecha_conmemorativa" id="fecha_conmemorativa" class="form-control" required="true" data-tipo="txt"  data-traducir="false" data-toggle="input-mask" data-mask-format="00/00/0000" />
                                    <span class="font-13 text-muted">ej. "DD/MM/YYYY"</span>
                                </div>
                            </div>
                        </div>
